...
def parse_args():
    ...
    parser.add_argument("--embedder", type=str, default="WGAN")
    parser.add_argument("--dataset", type=str, default="lake", help="Name of the dataset. Supported names are: wikics, cs, computers, photo, and physics")
    ...
    parser.add_argument("--es", type=int, default=200, help="Early Stopping Criterion")
...
def decide_config(root, dataset):
    ...
    if dataset == 'cora' or dataset == 'citeseer' or dataset == "pubmed":
        ...
        dataset = "Pollen"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Pollen/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "muraro":
        dataset = "Muraro"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Muraro/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
        ...
        dataset = "Segerstolpe"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Segerstolpe/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
        ...
        dataset = "Baron_human"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Baron_human/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "zeisel":
        ...
        dataset = "ESC"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/ESC/data.csv"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "timecourse":
        dataset = "Timecourse"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Timecourse/data.csv"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "yan":
        ...
        dataset = "Xin_2016"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Xin_2016/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
    elif dataset == "lake":
        dataset = "Lake_2016"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Lake_2016/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
        ...
        dataset = "Baron_mouse"
        root = osp.join(root, "pyg")
        filepath = "./test_csv/Baron_mouse/data.h5"
        # filepath = "./test_csv/Klein/raw-0.1.csv"
        params = {"kwargs": {"root": root, "name": dataset, "filepath": filepath},
                  "name": dataset, "class": Singlecell, "src": "pyg"}
