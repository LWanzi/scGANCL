...
class Singlecell(InMemoryDataset):
    ...
    def __init__(self, root, name, filepath, transform=None, pre_transform=None):
        ...
        self.labelpath = "./test_csv/ESC/label.csv"
    ...
    def process(self):
        ...
        # data, data_label, size_factor,gene = data_Preprocess.nomalize_for_Zeisel(self.filepath, self.labelpath, 2048,0);#读取csv文件
        #data, data_label, size_factor,gene = data_Preprocess.nomalize_for_ESC(self.filepath, self.labelpath, 2048,0);#读取csv文件
        data, data_label= data_Preprocess.nomalize_for_AF(self.filepath, 2048,raw);#读取h5文件
